...
\hline
	...
	\\
\hline
	\includegraphics[width=2cm]{idiotenseite/bilder/table_sine_wave.png} &
	$A\cdot\sin(t)$ &
	...
	$\frac{A^2}{2}$ \\
\hline	
	\includegraphics[width=2cm]{idiotenseite/bilder/table_full-wave_rectified_sine.png} &
	$A\cdot|\sin(t)|$ &
	$\frac{2}{\pi} \approx 0.637$ &
	$\frac{\pi}{2\sqrt{2}} \approx 1.11$ &
	$\frac{1}{\sqrt{2}} \approx 0.707$ &
	...
	\\
\hline
	\includegraphics[width=2cm]{idiotenseite/bilder/table_half-wave_rectified_sine.png} &
	...
	\\
\hline
	\includegraphics[width=2cm]{idiotenseite/bilder/table_triangle_wave.png} &
	$A\cdot\Lambda(t)$ &
	$\frac{1}{2}= 0.5$ &
	...
	$\frac{A^2}{3}$ \\
\hline	
	\includegraphics[width=2cm]{idiotenseite/bilder/table_square_wave.png} &
...
\hline	
	...
	-\\
\hline	
	\includegraphics[width=2cm]{idiotenseite/bilder/table_pulse_wide_wave.png} &
	&
